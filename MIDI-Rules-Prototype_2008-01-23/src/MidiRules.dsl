...
#
[then]Consume received message=retract(received_message);
[when]Receive short message with channel : {channel} , command : {command} , data1 : {data1} , data2 : {data2}=received_message : com.cycosolutions.midirules.ShortMessage(channel == {channel}, command == {command}, data1 == {data1}, data2 == {data2}, received_message_midi_port : midiPort, received_message_time : time); #Implicit variables received_message_midi_port, received_message_time
[when]Receive short message on midi in {midi_in_number} with channel : {channel} , command : {command} , data1 : {data1} , data2 : {data2}=received_message : com.cycosolutions.midirules.ShortMessage(channel == {channel}, command == {command}, data1 == {data1}, data2 == {data2}, midiPort == {midi_in_number}, received_message_time : time); #Implicit variable received_message_time
[then]Send short message to midi out {midi_out_number} with channel : {channel} , command : {command} , data1 : {data1} , data2 : {data2}=com.cycosolutions.midirules.Processor.getInstance().send({midi_out_number}, {channel}, {command}, {data1}, {data2});
[when]Receive short message=received_message : com.cycosolutions.midirules.ShortMessage(received_message_channel : channel, received_message_command: command, received_message_data1 : data1, received_message_data2 : data2, received_message_midi_port : midiPort, received_message_time : time);# Implicit variables received_message_channel, received_message_command, received_message_data1, received_message_data2, received_message_midi_port, received_message_time
...
[when]time is at least {ms} later then {other_time}=eval(received_message_time - other_time >= {ms})
[when]time is at most {ms} later then {other_time}=eval(received_message_time - other_time <= {ms})
[then]Pass message thru to midi out {midi_out_number}=com.cycosolutions.midirules.Processor.getInstance().send({midi_out_number}, received_message.getChannel(), received_message.getCommand(), received_message.getData1(), received_message.getData2());
...
[then]Send short message "{key}" in {delay}ms to midi out {midi_out_number} with channel : {channel} , command : {command} , data1 : {data1} , data2 : {data2}=com.cycosolutions.midirules.SendMidiMessageTimer timer = com.cycosolutions.midirules.Processor.getInstance().getSendMidiMessageTimer("{key}"); timer.setMidiOut(com.cycosolutions.midirules.Processor.getInstance()); timer.setMidiOutNumber({midi_out_number}); timer.setChannel({channel}); timer.setCommand({command}); timer.setData1({data1}); timer.setData2({data2}); timer.setExpirationTime(System.currentTimeMillis() + {delay});
[then]Send short message in {delay}ms to midi out {midi_out_number} with channel : {channel} , command : {command} , data1 : {data1} , data2 : {data2}=com.cycosolutions.midirules.Processor.getInstance().sendDelayed({midi_out_number}, {channel}, {command}, {data1}, {data2}, {delay});
...
[then]Trigger timer "{name}" in {delay}ms=com.cycosolutions.midirules.Processor.getInstance().scheduleTimer("{name}", System.currentTimeMillis() + {delay});
